...
export default function ProjectDetail1() {
  const gallery = ["/Pembelian 1.png"] // tambah path lain kalau ada
    ...
    <div className="bg-gradient-to-br from-white via-yellow-50 to-orange-50 min-h-screen text-black relative overflow-hidden">
      ...
      <section className="pt-28 md:pt-32 pb-6 relative z-10">
        ...
        <h1 className="text-center text-4xl md:text-5xl font-extrabold">
          <span className="text-black">Design Web UMKM </span>
      ...
      <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start pb-12 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="relative p-8">
            ...
            In creating this website design, we pay attention to the details of
            the features created, their functionality, and how the system flow is prototyped.
            </p>
            ...
            {/* Tombol figma */}
            <a
              href="https://www.figma.com/design/LV9vn23NpGovASljUYSjzh/UMKM_KLM-3_A2?node-id=0-1&m=dev&t=KADnQjACrGoWNinF-1"
              target="_blank"
