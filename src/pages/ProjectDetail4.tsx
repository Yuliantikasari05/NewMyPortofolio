...
export default function ProjectDetail1() {
  const gallery = ["/cookies.png"] // tambah path lain kalau ada
      ...
      <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start pb-12 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="relative p-8">
            ...
            This project is just the beginning of learning about full stack and getting to know the Laravel framework. In this project,
            I only used two programming languages, namely PHP to create the program framework and Blade to design the web interface.
            </p>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {["Laravel", "PHP", "Blade"].map((tech, index) => (
                  <span
                    key={tech}
            ...
            <div className="flex flex-wrap gap-4">
              {/* Tombol GitHub */}
              <a
                href="https://github.com/Yuliantikasari05/Laravel_MyCookies"
                target="_blank"
