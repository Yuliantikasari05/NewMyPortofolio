...
export default function ProjectDetail1() {
  const gallery = ["/POSTER GAME.png"] // tambah path lain kalau ada
    ...
    <div className="bg-gradient-to-br from-white via-yellow-50 to-orange-50 min-h-screen text-black relative overflow-hidden">
      ...
      <section className="pt-28 md:pt-32 pb-6 relative z-10">
        ...
        <h1 className="text-center text-4xl md:text-5xl font-extrabold">
          <span className="text-black">Virus Movement Game </span>
      ...
      <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start pb-12 relative z-10">
        ...
        <div className="relative group">
          ...
          {/* Image container */}
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/50 backdrop-blur-sm bg-white/10 p-2 flex justify-center">
            <div className="rounded-2xl overflow-hidden">
              <img
                src={gallery[0]}
                alt="E-Commerce Platform"
                className="w-[320px] h-[450px] object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
        ...
        <div className="relative">
          ...
          <div className="relative p-8">
            ...
            This game was created as a major project for a data structures and algorithms course.
            It was created using Greenfoot with the Java programming language.
            </p>

            <p className="text-gray-700 leading-relaxed mb-8 text-base">
            In this game, the story follows a patient who is looking for a hospital to receive treatment,
            but along the way, he must collect as many medicines as possible to earn points.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              {/* Tombol GitHub */}
              <a
                href="https://github.com/Yuliantikasari05/Virus-Movement#"
                target="_blank"
