...
export default function ProjectDetail1() {
  const gallery = ["/partograf2.png"] // tambah path lain kalau ada
      ...
      <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start pb-12 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="relative p-8">
            ...
            The Digital E-Partograph system is a Laravel-based web application designed to assist healthcare professionals (midwives, doctors, nurses) in digitally monitoring and documenting the delivery process. 
            This system replaces manual (paper) partographs with a more efficient and accurate digital interface.
            </p>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {["Laravel v.10", "MySQL", "Bootstrap 5", "JavaScript (Vanilla)", "HTMl & CSS"].map((tech, index) => (
                  <span
                    key={tech}
            ...
            {/* Tombol GitHub */}
            <a
              href="https://github.com/Yuliantikasari05/E-Partograf"
              target="_blank"
